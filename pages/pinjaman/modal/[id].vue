<template>
    <div class="content">
        ...
        <el-card class="!rounded-2xl !mb-6" shadow="never">
            <el-row :gutter="20">
                <el-col :md="18">
                    <h3 class="text-xl mb-4">Informasi Pengajuan Modal</h3>
                    <el-row class="mb-4">
                        <el-col :md="12">
                    ...
                    <el-row class="mb-4">
                        <el-col :md="12">
                            <base-reader label="Nominal Pinjaman">
                                {{ data.nominal }}
                            </base-reader>
                        </el-col>
                        <el-col :md="12">
                            <base-reader label="Durasi Pinjaman">
                                {{ data.durasi }}
                            </base-reader>
                        </el-col>
                    </el-row>
                    <el-row class="mb-4">
                        <el-col :md="12">
                            <base-reader label="Pemayaran Per bulan">
                               {{ data.tagihan }}
                            </base-reader>
                        </el-col>
                        <el-col :md="12">
                            <base-reader label="Status">
                                <state v-if="data.status == 'pending'">Menunggu Persetujuan</state>
                                <state v-else-if="data.status == 'disetujui'" type="success">Disetujui</state>
                                <state v-else type="danger">Ditolak</state>
                            </base-reader>
                        </el-col>
                    </el-row>
                </el-col>
        ...
        <el-dialog v-model="openModal" title="" class="!rounded-3xl" width="500">
            <div class="p-3 text-center" v-if="status == 'setuju'">
                ...
                <h3 class="font-semibold text-xl">Setujui Permintaan Pengajuan Modal</h3>
                <p class="text-base font-normal leading-6 text-zinc-400">Apakah Anda yakin ingin mengkonfirmasi permintaan? Jika sudah yakin, klik “Ya, saya yakin” untuk menyetujui permintaan.</p>
            ...
            <div class="p-3 text-center" v-else>
                ...
                <h3 class="font-semibold text-xl">Tolak Pengajuan Pinjaman Modal</h3>
                <p class="text-base font-normal leading-6 text-zinc-400">Apakah Anda yakin ingin menolak permintaan? Jika sudah yakin, klik “Ya, tolak permintaan” untuk menolak permintaan.</p>
...
import { ref } from 'vue';
useHead({ 
    title: 'Konfirmasi Pengajuan Pinjaman Modal' 
});
...
const data = ref({
    ...
    nama_pemilik : 'Irshal Ferdiansyah',
    email : 'LaundryCare@gmail.com',
    telp : '0892129037129312',
    nominal : 'Rp. 15.000.000',
    durasi : '3 Bulan',
    tagihan : 'Rp 5.034.000',
    status : 'pending',
    dokumen : 'Perjanjian_LaundryCare.pdf',
    ttd : '/images/ttd.png'
});
