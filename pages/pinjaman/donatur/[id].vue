<template>
    <div class="content">
        ...
        <el-card class="!rounded-2xl !mb-6" shadow="never">
            <el-row :gutter="20">
                <el-col :md="18">
                    <h3 class="text-xl mb-4">Informasi Donatur</h3>
                    <el-row class="mb-4">
                        <el-col :md="12">
                        ...
                        <el-col :md="12">
                            <base-reader label="Total Dana Pinjaman">
                                {{ data.pendanaan }}
                            </base-reader>
                        </el-col>
                    </el-row>
                ...
                <el-col :md="6">
                    <div class="float-end">
                        <img :src="data.image" alt="umkm-logo" class="rounded-full border h-48 w-48">
                    </div>
                </el-col>
            </el-row>
            <h3 class="text-xl mb-4">Informasi Pinjaman</h3>
            <el-row>
                <el-col :md="18">
                    <el-row class="mb-4">
                        <el-col :md="12">
                            <base-reader label="UMKM">
                                {{ data.umkm }}
                            </base-reader>
                        </el-col>
                        <el-col :md="12">
                            <base-reader label="Jumlah Pinjaman Modal">
                                {{ data.pinjaman }}
                            </base-reader>
                        </el-col>
                    </el-row>
                    <el-row class="mb-4">
                        <el-col :md="12">
                            <base-reader label="Dana Dibayarkan">
                                <span class="text-green-800">{{ data.dibayar }}</span>
                            </base-reader>
                        </el-col>
                        <el-col :md="12">
                            <base-reader label="Dana Belum Dibayar">
                                {{ data.sisa }}
                            </base-reader>
                        </el-col>
                    </el-row>
                    <el-row class="mb-4">
                        <el-col :md="12">
                            <base-reader label="Dokumen Perjanjian">
...
const data = ref({
    ...
    dibayar : 'Rp 3.000.000',
    sisa : 'Rp 6.000.000',
    dok_perjanjian : 'Perjanjian_Pinjaman Modal_Irshal_2024',
