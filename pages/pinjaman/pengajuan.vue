        ...
        <el-card body-class="!py-2 !px-3" class="!rounded-2xl !mb-6" shadow="never">
            <template v-if="tab == 'aktivasi'">
                <el-table class="!text-xs min-w-full" :data="dataAktivasi">
                    ...
                    <el-table-column align="center" width="156">
                        <template #default="scope">
                            <NuxtLink class="el-button !rounded-3xl !w-full"  :to="{ name : 'pinjaman-aktivasi-id', params : { id : scope.row.id}}">
                                Detail
                            </NuxtLink>
                        </template>
                    </el-table-column>
            ...
            <template v-else>
                <el-table class="!text-xs min-w-full" :data="dataModal">
                    ...
                    <el-table-column align="center" width="156">
                        <template #default="scope">
                            <NuxtLink class="el-button !rounded-3xl !w-full" :to="{ name : 'pinjaman-modal-id', params : { id : scope.row.id}}">
                                Detail
                            </NuxtLink>
                        </template>
                    </el-table-column>
...
<script setup>
useHead({ 
    title: 'Pengajuan Pinjaman Modal' 
});
