<template>
    <div class="content">
        ...
        <el-card class="!rounded-2xl !mb-6" shadow="never">
            <el-row :gutter="20">
                <el-col :md="18">
                    <h3 class="text-xl mb-4">Informasi Investor</h3>
                    <el-row class="mb-4">
                        <el-col :md="12">
                    ...
                    <el-row class="mb-4">
                        ...
                        <el-col :md="12">
                            <base-reader label="Nominal Investasi">
                                {{ data.nominal }}
                            </base-reader>
                        </el-col>
                    </el-row>
                ...
                <el-col :md="6">
                    <div class="float-end">
                        <img :src="data.image" alt="investor-image" class="rounded-full border h-24 w-24">
                    </div>
                </el-col>
            </el-row>
            ...
            <base-reader label="Dokumen Perjanjian" class="mb-4">
                <a href="">{{ data.dok_perjanjian}}</a>
            </base-reader>
            <h3 class="text-xl mb-4">Informasi Rekening</h3>
            <el-row :gutter="20">
                <el-col :md="8">
                    <base-reader label="Nama Bank">
                        {{ data.rekening_bank }}
                    </base-reader>
                </el-col>
                <el-col :md="8">
                    <base-reader label="Nama Pemilik Rekening">
                        {{ data.rekening_pemilik }}
                    </base-reader>
                </el-col>
                <el-col :md="8">
                    <base-reader label="No. Rekening">
                        {{ data.rekening_nomor }}
                    </base-reader>
                </el-col>
            </el-row>
        ...
        <el-dialog v-model="openModal" title="" class="!rounded-3xl" width="500">
            <div class="p-3 text-center" v-if="status == 'setuju'">
                ...
                <h3 class="font-semibold text-xl">Setujui Pengajuan Investor</h3>
                <p class="text-base font-normal leading-6 text-zinc-400">Konfirmasi pengajuan investor. Apakah Anda telah memeriksa semua informasi dan dokumen terkait sebelum menyetujui pengajuan ?</p>
            ...
            <div class="p-3 text-center" v-else>
                ...
                <h3 class="font-semibold text-xl">Tolak Pengajuan Investor</h3>
...
useHead({ 
    title: 'Konfirmasi Pengajuan Investor' 
});
...
const data = ref({
    ...
    dok_perjanjian : 'Perjanjian_Investasi_Irshal_2024',
    rekening_bank : 'Bank Central Asia (BCA)',
    rekening_pemilik : 'Alba Alfarizi',
    rekening_nomor : '44161231239'
});
