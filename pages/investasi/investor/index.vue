    ...
    <div class="content">
        ...
        <el-card body-class="!py-2 !px-3" class="!rounded-2xl !mb-6" shadow="never">
            <el-table class="!text-xs min-w-full" :data="investorList">
                ...
                <el-table-column label="Nama Investor" align="center" header-align="center">
                ...
                <el-table-column label="Nama Investasi" align="center" header-align="center">
                    <template #default="scope">
                        <div class="flex align-middle justify-start">
                            <div>{{ scope.row.proyek }}</div>
                        </div>
                    </template>
                </el-table-column>
                <el-table-column prop="investasi" label="Dana Investasi" align="center" header-align="center"/>
                ...
                <el-table-column align="center" width="156">
                    <template #default="scope">
                        <NuxtLink class="el-button !rounded-3xl !w-full" :to="{ name : 'investasi-investor-id', params : { id : scope.row.id}}">
                            Detail
